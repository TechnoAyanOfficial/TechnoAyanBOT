...
DEFAULTUSER = str(ALIVE_NAME) if ALIVE_NAME else "**Abey Heroku Me jaake ALIVE_NAME Set Kar**"

USER_BOT_WARN_ZERO = "Congratulations !! You Have Been\nBlocked and reported as Spam\n\nNow Count Stars And Enjoy😏"
USER_BOT_NO_WARN = ("[──▄────▄▄▄▄▄▄▄────▄─── \n─▀▀▄─▄█████████▄─▄▀▀── \n─────██─▀███▀─██────── \n───▄─▀████▀████▀─▄──── \n─▀█────██▀█▀██────█▀──](tg://user?id=1111847352)\n\n"
                    "`Hello! This is an automated message.You have found your way here to my master,`"
                    f"{DEFAULTUSER}'s` inbox.\n\n"
                    "Leave your name, phone number, address and 179k$ and hopefully you'll get a reply within 2 light years.`\n\n"
